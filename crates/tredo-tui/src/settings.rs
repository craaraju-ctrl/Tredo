...
fn render_agents_panel(
    ...
    let block = Block::default()
        .title(Span::styled(
            ...
            Style::default()
                .fg(if focused { THEME.neutral } else { THEME.warning })
                .add_modifier(Modifier::BOLD),
        ))
        .borders(Borders::ALL)
        .border_style(Style::default().fg(border_color));
...
fn render_skills_panel(
    ...
    let block = Block::default()
        .title(Span::styled(
            ...
            Style::default()
                .fg(if focused { THEME.neutral } else { THEME.positive })
                .add_modifier(Modifier::BOLD),
        ))
        .borders(Borders::ALL)
        .border_style(Style::default().fg(border_color));
...
fn render_risk_params_panel(
    ...
    let block = Block::default()
        .title(Span::styled(
            ...
            Style::default()
                .fg(if focused { THEME.neutral } else { THEME.negative })
                .add_modifier(Modifier::BOLD),
        ))
        .borders(Borders::ALL)
        .border_style(Style::default().fg(border_color));
        ...
        .enumerate()
    {
        ...
        lines.push(Line::from(vec![
            Span::styled(
                format!("  {} ", marker),
                Style::default().fg(if is_selected { THEME.neutral } else { THEME.muted }),
            ),
            Span::styled(
                format!("{:<18}", name),
                Style::default()
